// Original challenge can be found at https://www.hackerrank.com/challenges/countingsort1/problem
...
(()=> {
    ...
    arr =  string.split(' ').map(val => +val)
    console.log('countingSort(arr): ' , countingSort(arr))
})()